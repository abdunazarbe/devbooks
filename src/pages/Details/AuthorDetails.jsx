        ...
        <div className="wrapper flex gap-x-[97px]">
          <div>
            ...
            <div className="flex justify-around">
              <div>
                <p className="text-gray-500 text-[12px] font-['Visuelt']">
                  Tavallud sanasi
                </p>
                <p className="text-[39px] font-['Rotter'] text-[#C9AC8C]">
                  5-Avg 1941
                </p>
                <p className="text-gray-500 text-[12px] font-['Visuelt']">
                  Toshkent, Uzbekistan
          ...
          <div>
            <h1 className="mb-5 text-[48px] text-[#C9AC8C] font-['Rotter']">
              O’tkir Hoshimov
            </h1>
            <p className="mb-5 text-[16px] leading-[23px] max-w-[671px]">
            ...
            <div className="text-[#C9AC8C] font-['Rotter'] uppercase flex items-center">
              <span>
                <i className="bx bxs-bookmark-star text-[20px]"></i> Ijodi
              </span>
            </div>
            <p className="text-[12px] leading-[18px] w-[362px] mb-[50px] ms-[20px]">
            ...
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-[#C9AC8C] uppercase text-[31px] font-['Rotter']">
                Asarlari
              </h2>
